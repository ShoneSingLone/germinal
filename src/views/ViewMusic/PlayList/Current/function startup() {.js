	...
	for (var i = 0; i < touches.length; i++) {
		if (
			...
			if (idx >= 0) {
				...
				ctx.moveTo(
					ongoingTouches[idx].clientX - offset.x,
					ongoingTouches[idx].clientY - offset.y
				);
				log(
	...
	for (var i = 0; i < touches.length; i++) {
		if (
			...
			if (idx >= 0) {
				...
				ctx.fillRect(
					touches[i].clientX - 4 - offset.x,
					touches[i].clientY - 4 - offset.y,
					8,
					8
