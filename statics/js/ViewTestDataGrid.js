...
import { $ as $t, e as defDataGridOption, a as _global__, f as defCol, g as defColActions, h as State_UI, i as defColActionsBtnlist, j as UI, k as defItem, m as _export_sfc } from "./index.js";
  ...
  data() {
    return {
      State_table: defDataGridOption({
        ...
        columns: __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, defCol({
          label: $t("a").label,
          prop: "a"
        })), defCol({
          label: $t("b").label,
