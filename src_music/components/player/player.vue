...
import Scroll from "msrc/components/base/scroll/scroll";
import MiniPlayer from "./mini-player";
import { formatTime } from "msrc/assets/js/util";
import { PLAY_MODE } from "msrc/assets/js/constant";
import { State_Music } from "msrc/stateMusic";
...
export default {
	...
	setup() {
		...
		// vuex
		const fullScreen = computed(() => State_Music.fullScreen);
