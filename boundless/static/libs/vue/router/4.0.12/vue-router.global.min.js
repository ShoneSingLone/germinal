...
var VueRouter = (function(exports, vue) {
    ...
    function onBeforeRouteLeave(leaveGuard) {
        ...
        const activeRecord = vue.inject(matchedRouteKey,
            ...
            {}).value;
        if (!activeRecord) {
            warn('No active route record was found when calling `onBeforeRouteLeave()`. Make sure you call this function inside of a component child of <router-view>. Maybe you called it inside of PageToolboxHome.vue?');
            return;
        }
    ...
    function onBeforeRouteUpdate(updateGuard) {
        ...
        const activeRecord = vue.inject(matchedRouteKey,
            ...
            {}).value;
        if (!activeRecord) {
            warn('No active route record was found when calling `onBeforeRouteUpdate()`. Make sure you call this function inside of a component child of <router-view>. Maybe you called it inside of PageToolboxHome.vue?');
            return;
        }
